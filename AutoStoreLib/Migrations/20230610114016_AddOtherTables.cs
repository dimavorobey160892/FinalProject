    ...
    public partial class AddOtherTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuestionMessages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerMessages_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AnswerMessages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerMessages_AnswerId",
                table: "AnswerMessages",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerMessages_UserId",
                table: "AnswerMessages",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionMessages_UserId",
                table: "QuestionMessages",
                column: "UserId");
